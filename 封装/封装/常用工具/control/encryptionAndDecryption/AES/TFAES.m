...
+ (NSString *)TF_encrptyWithNSString:(NSString *)str key:(NSString *)key iv:(NSString *)iv {
    ...
    NSData *encrptData  = [self TF_encrptyWithData:data dataKey:keyData dataIv:ivData];
...
+ (NSString *)TF_encrptyWithString:(NSString *)str key:(NSString *)key {
    ...
    return [[self TF_encrptyWithData:strData dataKey:keyData] base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
}
...
+ (NSString *)TF_decrptyWithString:(NSString *)str key:(NSString *)key iv:(NSString *)iv {
    ...
    NSData *resultData  = [self TF_decrptyWithData:data dataKey:keyData dataIv:aesIv];
...
+ (NSString *)TF_decrptyWithString:(NSString *)str hexkey:(NSString *)key hexIv:(NSString *)iv {
    ...
    NSData *resultData  = [self TF_decrptyWithData:data dataKey:keyData dataIv:ivData ];
    return [[NSString alloc] initWithData:resultData encoding:NSUTF8StringEncoding];
}
...
+ (NSString *)TF_decrptyWithString:(NSString *)str hexkey:(NSString *)key {
    ...
    NSData *resultData  = [self TF_decrptyWithData:strData dataKey:keyData];
    return [[NSString alloc] initWithData:resultData encoding:NSUTF8StringEncoding];
}
+ (NSString *)TF_decrptyWithString:(NSString *)str key:(NSString *)key {
    ...
    return [[NSString alloc] initWithData:[self TF_decrptyWithData:strData dataKey:keyData] encoding:NSUTF8StringEncoding];
}
...
+ (NSString *)TF_AES256DecryptWithString:(NSString *)str key:(NSString *)key {
    NSData *data = [[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters];
