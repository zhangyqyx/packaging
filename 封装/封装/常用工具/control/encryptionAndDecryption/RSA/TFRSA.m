...
+ (NSString *)TF_encryptString:(NSString *)str
    ...
    NSData *data    = [self TF_encryptData:[str dataUsingEncoding:NSUTF8StringEncoding]
                              publicKey:pubKey];
...
+ (NSString *)TF_decryptString:(NSString *)str
    ...
    data            = [self TF_decryptData:data privateKey:privKey];
...
+ (NSString *)TF_encryptNSString:(NSString *)str
               publicKeyWithPath:(NSString *)filePath {
    NSData *encryptData = [self TF_encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] publicKeyWithPath:filePath];
...
+ (NSString *)TF_decryptNSString:(NSString *)str
                      privateKeyWithPath:(NSString *)filePath
                        password:(NSString *)password{
    NSData *decryptData = [self TF_decryptData:[[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters]  privateKeyWithPath:filePath password:password];
